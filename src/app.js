...
createApp({
  setup() {
    ...
    const isMobileViewport = ref(window.matchMedia("(max-width: 680px)").matches);
    ...
    function openStockDetails(stock) {
      if (!isMobileViewport.value) return;
    ...
    function handleViewportChange() {
      ...
      if (hoveredStock.value && !mobile) schedulePopoverPosition();
    }
